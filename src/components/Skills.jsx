...
function GroupCard({ category, prefix, color, glow, skills, cardDelay }) {
  ...
  return (
    <motion.div
      ...
      className="glass rounded p-6 border border-[#003300] hover:border-[#00ff41]/30 transition-colors duration-300"
      style={{ boxShadow: `0 0 30px ${glow}` }}
    >
      <div className="flex items-center gap-2 mb-5">
        <span className="text-[#004d00] text-xs">{prefix}@kum-jude-bama:~$</span>
        <h3 className="text-xs tracking-widest uppercase" style={{ color }}>{category}</h3>
      </div>
