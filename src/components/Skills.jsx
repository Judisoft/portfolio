...
function GroupCard({ category, prefix, color, glow, skills, cardDelay }) {
  ...
  return (
    <motion.div
      ...
      className="rounded-xl overflow-hidden border border-[#00ff41]/20 hover:border-[#00ff41]/40 transition-colors duration-300"
    ...
    >
      ...
      <div className="flex items-center gap-2 px-4 py-2.5 bg-[#1a1a1a] border-b border-[#00ff41]/10">
        ...
        <span className="mx-auto text-xs tracking-widest" style={{ color }}>{category.toLowerCase()}.sh</span>
      </div>
      {/* Body */}
